...
const ConsultationNotificationToast = () => {
  const { user } = useAuth();
      ...
      const channel = supabase
        ...
        .on(
          ...
          (payload) => {
            ...
            // Show toast notification with Accept button
            toast({
              ...
              description: (
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm">Patient ID: {newConsultation.patient_id.slice(0, 8)}...</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-xs text-gray-600">
                        {new Date(newConsultation.created_at!).toLocaleTimeString()}
                      </span>
                    </div>
                    <Badge 
                      className={
                        newConsultation.priority === 'urgent' ? 'bg-red-100 text-red-800' :
                        newConsultation.priority === 'high' ? 'bg-orange-100 text-orange-800' :
